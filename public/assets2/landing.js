    ...
    for (const [o, s] of n) {
        ...
        (c.innerHTML = o),
            ...
            c.addEventListener("click", () => {
                ...
                e.appendChild(y), l && l.destroyAndRemove();
                for (const m of r)
                    m.classList[m === c ? "add" : "remove"]("active");
                (l = new Pickr(
                    Object.assign({ el: y, theme: o, default: "#845adf" }, s)
                )),
                    l.on("changestop", (m, a) => {
                        let d = a.getColor().toRGBA();
                        document
                            .querySelector("html")
                            .style.setProperty(
                                "--primary-rgb",
                                `${Math.floor(d[0])}, ${Math.floor(
                                    d[1]
                                )}, ${Math.floor(d[2])}`
                            ),
...
(function () {
    document.querySelector("html"),
        ...
        document.querySelector("#switcher-canvas") && (q(), b(), u());
})();
...
function b() {
    ...
    (n = document.querySelector("#switcher-light-theme")),
        (r = document.querySelector("#switcher-dark-theme")),
        (e = document.querySelector("#switcher-ltr")),
        (t = document.querySelector("#switcher-rtl")),
        (l = document.querySelector("#switcher-primary")),
        (o = document.querySelector("#switcher-primary1")),
        (s = document.querySelector("#switcher-primary2")),
        (c = document.querySelector("#switcher-primary3")),
        (y = document.querySelector("#switcher-primary4")),
        (m = document.querySelector("#reset-all")),
        ...
        t.addEventListener("click", () => {
            localStorage.setItem("ynexlandingrtl", !0),
                localStorage.removeItem("ynexlandingltr"),
                S();
        }),
        e.addEventListener("click", () => {
            localStorage.setItem("ynexlandingltr", !0),
                localStorage.removeItem("ynexlandingrtl"),
                g();
        }),
        m.addEventListener("click", () => {
            a.style.removeProperty("--primary-rgb"),
                a.removeAttribute("dir", "rtl"),
...
function g() {
    ...
    (t = document.querySelector("#style")) == null ||
        t.setAttribute(
            "href",
            "https://laravelui.spruko.com/ynex/build/assets/libs/bootstrap/css/bootstrap.min.css"
        ),
...
function S() {
    ...
    document.querySelector("html").setAttribute("dir", "rtl"),
        (t = document.querySelector("#style")) == null ||
            t.setAttribute(
                "href",
                "https://laravelui.spruko.com/ynex/build/assets/libs/bootstrap/css/bootstrap.rtl.min.css"
            ),
        u();
}
localStorage.ynexlandingrtl && S();
...
function w() {
    ...
    e.setAttribute("data-theme-mode", "dark"),
        i(),
        localStorage.setItem("ynexlandingdarktheme", !0),
...
function k() {
    document.querySelector("html"), u(), localStorage.clear(), i(), g(), f();
}

function u() {
    localStorage.getItem("ynexlandingdarktheme") &&
        (document.querySelector("#switcher-dark-theme").checked = !0),
        localStorage.getItem("ynexlandingrtl") &&
...
function q() {
    if (
        ...
        localStorage.ynexlandingdarktheme &&
            document
                .querySelector("html")
                .setAttribute("data-theme-mode", "dark"),
        localStorage.ynexlandingrtl &&
            document.querySelector("html").setAttribute("dir", "rtl"),
        localStorage.ynexlayout)
    ) {
        let e = document.querySelector("html");
...
function v() {
    for (
        ...
        var n = window.innerHeight,
            r = e[t].getBoundingClientRect().top,
            l = 150;
        r < n - l
...
v();
const B = document.querySelectorAll(".side-menu__item");
B.forEach((e) => {
    e != "javascript:void(0);" &&
        e !== "#" &&
        e.addEventListener("click", (t) => {
            var n;
            t.preventDefault(),
                (n = document.querySelector(e.getAttribute("href"))) == null ||
                    n.scrollIntoView({ behavior: "smooth", offsetTop: 1 - 60 });
        });
});

function E(e) {
    const t = document.querySelectorAll(".side-menu__item"),
        n =
            window.pageYOffset ||
    ...
    t.forEach((r) => {
        ...
        const s = n + 73;
        (o == null ? void 0 : o.offsetTop) <= s &&
        (o == null ? void 0 : o.offsetTop) + o.offsetHeight > s
            ? (r.parentElement.parentElement.classList.contains("child1") &&
                  r.parentElement.parentElement.parentElement.children[0].classList.add(
                      "active"
                  ),
              r.classList.add("active"),
              (c = r.closest(".child1")) != null &&
...
const h = document.querySelector(".scrollToTop"),
